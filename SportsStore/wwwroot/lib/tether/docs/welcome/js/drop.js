(function() {
    ...
    _ref = Tether.Utils, extend = _ref.extend, addClass = _ref.addClass, removeClass =
        _ref.removeClass, hasClass = _ref.hasClass, Evented = _ref.Evented;
        ...
        DropInstance = (function(_super) {
            ...
            DropInstance.prototype.setupEvents = function() {
                ...
                if (__indexOf.call(events, 'click') >= 0) {
                    this.target.addEventListener(clickEvent,
                        function() {
                            return _this.toggle();
                        });
                    document.addEventListener(clickEvent,
                        function(event) {
                            if (!_this.isOpened()) {
                                return;
                            }
                ...
                if (__indexOf.call(events, 'hover') >= 0) {
                    ...
                    return this.target.addEventListener('mouseout',
                        function() {
                            return _this.close();
                        });
                }
