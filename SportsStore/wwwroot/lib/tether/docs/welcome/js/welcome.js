(function() {
    ...
    setupHero = function() {
        ...
        positions = [
            'top left', 'left top', 'left middle', 'left bottom', 'bottom left', 'bottom center',
            'bottom right', 'right bottom', 'right middle', 'right top', 'top right', 'top center'
        ];
        if (isMobile) {
        ...
        finalDropState = function() {
            ...
            $(drops['bottom right'].dropContent)
                .html('<a class="button" href="http://github.com/HubSpot/tether">★ On Github</a>');
            drops['top left'].open();
    ...
    setupBrowserDemo = function() {
        ...
        $(window).scroll(function() {
            ...
            if ($startPoint.position().top < scrollTop &&
                scrollTop + window.innerHeight < $stopPoint.position().top) {
                ...
                return $sections.each(function() {
                    ...
                    if (($section.position().top < scrollTop &&
                        scrollTop < $section.position().top + $section.outerHeight())) {
