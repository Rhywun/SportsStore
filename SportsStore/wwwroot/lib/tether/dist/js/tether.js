                ...
                [
                    {
                            ...
                            if (typeof this.targetModifier !== 'undefined') {
                                if (this.targetModifier === 'visible') {
                                    ...
                                    if (height < 408 && this.target === document.body) {
                                        fitAdj = -0.00011 * Math.pow(height, 2) -
                                            0.00727 * height +
                                            22.58;
                                    }
                                    ...
                                    var scrollPercentage = this.target.scrollTop /
                        ...
                        value: function enable() {
                            ...
                            var pos = arguments.length <= 0 || arguments[0] === undefined
                                ? true
                                : arguments[0];
                        ...
                        value: function updateAttachClasses(elementAttach, targetAttach) {
                            ...
                            if (elementAttach.left) {
                                add.push(this.getClass('element-attached') +
                                    '-' +
                                    elementAttach.left);
                            }
                            if (targetAttach.top) {
                            ...
                            if (targetAttach.left) {
                                add.push(this.getClass('target-attached') +
                                    '-' +
                                    targetAttach.left);
                            }
                        ...
                        value: function position() {
                            ...
                            var targetAttachment =
                                autoToFixedAttachment(this.targetAttachment, this.attachment);
                            ...
                            var targetOffset = offsetToPx(attachmentToOffset(targetAttachment),
                                targetSize);
                            ...
                            if (['', 'static'].indexOf(doc.body.style.position) === -1 ||
                                ['', 'static'].indexOf(doc.body.parentElement.style.position) ===
                                -1) {
                        ...
                        value: function move(pos) {
                            ...
                            var moved = false;
                            if ((same.page.top || same.page.bottom) &&
                            ...
                            } else if (typeof same.offset !== 'undefined' &&
                                same.offset.top &&
                                same.offset.left) {
                                (function() {
                                    css.position = 'absolute';
...
/* globals TetherBase */
        ...
        TetherBase.modules.push({
            position: function position(_ref) {
                ...
                var _cache = this.cache('element-bounds',
                    function() {
                ...
                var targetSize = this.cache('target-bounds',
                    function() {
