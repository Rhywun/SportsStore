 ...
 */
    ...
    var Carousel = function($) {
        ...
        var Carousel = function() {
            ...
            Carousel.prototype._triggerSlideEvent =
                function _triggerSlideEvent(relatedTarget, eventDirectionName) {
            ...
            Carousel.prototype._setActiveIndicatorElement =
                function _setActiveIndicatorElement(element) {
                    if (this._indicatorsElement) {
                        $(this._indicatorsElement).find(Selector.ACTIVE)
            ...
            Carousel._jQueryInterface = function _jQueryInterface(config) {
                return this.each(function() {
                    ...
                    if ((typeof config === 'undefined' ? 'undefined' : _typeof(config)) ===
                        'object') {
    ...
    var Collapse = function($) {
        ...
        var Collapse = function() {
            function Collapse(element, config) {
                ...
                this._element = element;
                this._config = this._getConfig(config);
                this._triggerArray = $.makeArray($('[data-toggle="collapse"][href="#' +
                    element.id +
                    '"],' +
            ...
            Collapse.prototype.show = function show() {
                ...
                if (this._triggerArray.length) {
                    $(this._triggerArray).removeClass(ClassName.COLLAPSED)
                ...
                var complete = function complete() {
                    $(_this6._element).removeClass(ClassName.COLLAPSING)
                ...
                $(this._element).one(Util.TRANSITION_END, complete)
                    .emulateTransitionEnd(TRANSITION_DURATION);
            ...
            Collapse.prototype.hide = function hide() {
                ...
                if (this._triggerArray.length) {
                    $(this._triggerArray).addClass(ClassName.COLLAPSED)
                ...
                var complete = function complete() {
                    ...
                    $(_this7._element).removeClass(ClassName.COLLAPSING)
                        .addClass(ClassName.COLLAPSE).trigger(Event.HIDDEN);
                };
                ...
                function _addAriaAndCollapsedClass(element, triggerArray) {
                    if (element) {
                        ...
                        if (triggerArray.length) {
                            $(triggerArray).toggleClass(ClassName.COLLAPSED, !isOpen)
 ...
 */
    ...
    var Dropdown = function($) {
        ...
        $(document)
            ...
            .on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, Dropdown.prototype.toggle).on(
        ...
        var Modal = function() {
            ...
            Modal.prototype.show = function show(relatedTarget) {
                ...
                $(this._dialog).on(Event.MOUSEDOWN_DISMISS,
                    function() {
                        $(_this9._element).one(Event.MOUSEUP_DISMISS,
                            function(event) {
        ...
        var ScrollSpy = function() {
            ...
            ScrollSpy.prototype._activate = function _activate(target) {
                ...
                if ($link.hasClass(ClassName.DROPDOWN_ITEM)) {
                    $link.closest(Selector.DROPDOWN).find(Selector.DROPDOWN_TOGGLE)
                        .addClass(ClassName.ACTIVE);
                    $link.addClass(ClassName.ACTIVE);
                } else {
                    // todo (fat) this is kinda sus...
                    // recursively add actives to tested nav-links
                    $link.parents(Selector.LI).find('> ' + Selector.NAV_LINKS)
                        .addClass(ClassName.ACTIVE);
                }
        ...
        var Tab = function() {
            ...
            Tab.prototype._activate = function _activate(element, container, callback) {
                ...
                if (active && isTransitioning) {
                    $(active).one(Util.TRANSITION_END, complete)
                        .emulateTransitionEnd(TRANSITION_DURATION);
                } else {
                    complete();
                }
            ...
            Tab.prototype._transitionComplete =
                function _transitionComplete(element, active, isTransitioning, callback) {
                    if (active) {
                    ...
                    if (element.parentNode &&
                        ...
                        if (dropdownElement) {
                            $(dropdownElement).find(Selector.DROPDOWN_TOGGLE)
                                .addClass(ClassName.ACTIVE);
                        }
        ...
        var Tooltip = function() {
            ...
            Tooltip.prototype.show = function show() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var isInTheDom = $.contains(this.element.ownerDocument.documentElement,
                        this.element);
                    ...
                    if (Util.supportsTransitionEnd() && $(this.tip).hasClass(ClassName.FADE)) {
                        this._isTransitioning = true;
                        $(this.tip).one(Util.TRANSITION_END, complete)
            ...
            Tooltip.prototype.hide = function hide(callback) {
                ...
                if (Util.supportsTransitionEnd() && $(this.tip).hasClass(ClassName.FADE)) {
                    this._isTransitioning = true;
                    $(tip).one(Util.TRANSITION_END, complete)
                        .emulateTransitionEnd(TRANSITION_DURATION);
                } else {
                    complete();
                }
            ...
            Tooltip.prototype.setElementContent = function setElementContent($element, content) {
                ...
                if ((typeof content === 'undefined' ? 'undefined' : _typeof(content)) ===
                    'object' &&
            ...
            Tooltip.prototype._setListeners = function _setListeners() {
                ...
                triggers.forEach(function(trigger) {
                    if (trigger === 'click') {
                        $(_this24.element).on(_this24.constructor.Event.CLICK,
                    ...
                    $(_this24.element).closest('.modal').on('hide.bs.modal',
                        function() {
                            return _this24.hide();
                        });
                });
