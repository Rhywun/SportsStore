    ...
    var Tooltip = function() {
        ...
        Tooltip.prototype._setListeners = function _setListeners() {
            ...
            triggers.forEach(function(trigger) {
                if (trigger === 'click') {
                    $(_this3.element).on(_this3.constructor.Event.CLICK,
                ...
                $(_this3.element).closest('.modal').on('hide.bs.modal',
                    function() {
                        return _this3.hide();
                    });
            });
        ...
        Tooltip._jQueryInterface = function _jQueryInterface(config) {
            return this.each(function() {
                ...
                var _config = (typeof config === 'undefined' ? 'undefined' : _typeof(config)) ===
                    'object' &&
                    config;
